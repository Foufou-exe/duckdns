<template>
    <h1 class="text-5xl font-extrabold mb-5">About Duck DNS</h1>
    <div class="mb-5">
        <h3 class="text-2xl font-bold mb-2">What does the service actually do?</h3>
        <p>
    ...
    <div class="mb-5">
        <h3 class="text-2xl font-bold mb-2">Who are we?</h3>
        <p>The team consists of two software engineers who each have worked in the industry for over 15 years</p>
    </div>

    <div class="mb-5">
        <h3 class="text-2xl font-bold mb-2">Why do I need a dynamic DNS service</h3>
        <p>
    ...
    <div class="mb-5">
        <h3 class="text-2xl font-bold mb-2">Why make a free DDNS service?</h3>
