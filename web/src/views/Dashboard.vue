    ...
    <table class="table">
        ...
        <thead>
            <tr>
                <th>
                <label>
                    <input id="checkAll" type="checkbox" class="checkbox" @change="checkAll()" />
                </label>
                </th>
                <th>Description</th>
            </tr>
        ...
        <!-- row 1 -->
            <tr>
                <th>
                <label>
                    <input id="categorie" name="Feature" type="checkbox" class="checkbox" />
                </label>
                </th>
                <td>
                    <p>✨Feature</p>
        ...
        <!-- row 2 -->
            <tr>
                <th>
                <label>
                    <input id="categorie" name="Release" type="checkbox" class="checkbox" />
                </label>
                </th>
                <td>
                    <p>🎉Release</p>
        ...
        <!-- row 3 -->
            <tr>
                <th>
                <label>
                    <input id="categorie" name="Epic" type="checkbox" class="checkbox" />
                </label>
                </th>
                <td>
                <div class="flex">
        ...
        <!-- row 4 -->
            <tr>
                <th>
                <label>
                    <input id="categorie" name="Information" type="checkbox" class="checkbox"/>
                </label>
                </th>
                <td>
                <div class="flex">
...
function AjoutNews() {
    ...
    if (lstcategorie.length > 0 && title != "" && datenew != "" && contentnew != "") {
