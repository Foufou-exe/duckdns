            ...
            <div class="space-y-2 mt-4">
                ...
                <strong class="text-secondary">
                    ...
                    <div class="bg-black p-2 rounded">
                        ...
                        <div v-else class="text-white">{{ hide }}</div>
                    </div>
                </strong>
            
            </div>
            <button class="btn btn-secondary btn-outline btn-normal" @click="toggleTokenVisibility">{{ showToken ? 'Hide' : 'Show' }} Token</button>
        </div>
    </div>
