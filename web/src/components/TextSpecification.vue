<template>
    <div>
        ...
        <h3 class="text-2xl font-bold mb-5">HTTP API</h3>
            <p class="font-thin">
            ...
            <br><br>
            <p class="font-thin">A normal bad response is :</p>
            <br>
        <div class="mockup-code">
            <pre data-prefix="$" class="text-error"><code>KO</code></pre>
        </div>
        <br>
        <p class="font-thin">If you add the <b>&verbose=true</b> parameter to your request, then OK responses have more information :</p>
        <br>
        <div class="mockup-code">
            <pre data-prefix="$" class="text-success"><code>OK</code></pre> 
        ...
        <i class="font-thin">TODO : Note that the TXT record does not show up in the WEB interface </i>
        <br><br>
